            ...
            <div class="col-lg-12">
                <div class="header--one-main">
                    <div class="row align-items-center header-top-one">
                        <div class="col-lg-3">
                            <a href="/" style="height: 120px!important; display: block; overflow: hidden;padding: 0!important" class="logo-area">
                                <img style="height: 150px; object-fit: cover;" src="frontendAssets/images/logo/logo_nobg.jpeg" alt="logo-area">
                            </a>
                        </div>
                        <div class="col-lg-9">
...
{{--                                </div>--}}
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div style="padding-top: 0!important; justify-content: space-around; align-items: center" class="header-nav-area header--sticky">
                                <div class="logo-md-sm-device">
                                    <a style="height: 60px!important; width: 100px!important; display: block; overflow: hidden;" href="#" class="logo">
                                        <img style="height: 100px; width: 100px; object-fit: cover;" src="{{asset('frontendAssets/images/logo/logo_nobg.jpeg')}}" alt="logo">
                                    </a>
                                </div>
...
{{--                                                            <ul class="pages">--}}
{{--                                                                <li><a class="current" href="index.html">Cleaning</a></li>--}}
...
{{--                                                            <ul class="pages">--}}
{{--                                                                <li><a href="onepage.html">Cleaning Onepage</a></li>--}}
...
{{--                                                                <li><a href="https://themewant.com/products/html/drill/electric/onepage.html">Electric Onepage</a></li>--}}
{{--                                                            </ul>--}}
{{--                                                        </li>--}}
{{--                                                    </div>--}}
{{--                                                </ul>--}}
